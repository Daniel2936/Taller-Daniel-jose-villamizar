...
let nota1,nota2,nota3,cont

function proestudiante(n1,n2,n3) {
    return (n1+n2+n3)/3
}

function progeneral(promedio,estudiantes) {
    ...
    if(Number.isInteger(opcion)&&opcion>0&&opcion<7){
        switch (opcion) {
                ...
                estudiantes.forEach(e => {
                    ...
                    if(nota1>=0 && nota1<=5){
                        ...
                        if(nota2>=0 && nota2<=5){
                            ...
                            if(nota3>=0 && nota3<=5){
                                promEstudiante=proestudiante(nota1,nota2,nota3)
            ...
            case 5:
                ...
                console.log("El promedio general del curso fue "+progeneral(promGeneral,cantEstudiante))               
                break;
            default:
                break;
        }
